...
class SigilKSMUnsure0Instruction extends SigilKSMInstruction {
  public override get const(): boolean {
    return false;
  }

  public override get opcode(): number {
    return SigilKSMOpCode.OPCODE_UNSURE0;
  }
...
export { SigilKSMUnsure0Instruction, SigilKSMUnsure0Instruction as KSMUnsure0Instruction };
