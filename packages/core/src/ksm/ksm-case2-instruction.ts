...
class SigilKSMCase2Instruction extends SigilKSMInstruction {
  ...
  public override get opcode(): number {
    return SigilKSMOpCode.OPCODE_CASE2;
  }
...
export { SigilKSMCase2Instruction, SigilKSMCase2Instruction as KSMCase2Instruction };
