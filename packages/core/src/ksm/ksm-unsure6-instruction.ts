...
class SigilKSMUnsure6Instruction extends SigilKSMInstruction {
  ...
  public unknown4: SigilKSMVariable;
  ...
  public constructor() {
    ...
    this.unknown4 = new SigilKSMVariable();
  }
  ...
  public override get opcode(): number {
    return SigilKSMOpCode.OPCODE_UNSURE6;
  }
  ...
  protected _parse(buffer: CTRMemory, ctx: SigilKSMContext): void {
    ...
    this.unknown4 = ctx.var(buffer.u32());
  }

  protected override _sizeof(): number {
    return CTRMemory.U32_SIZE * 5;
  }
}

export {
  SigilKSMUnsure6Instruction,
  SigilKSMUnsure6Instruction as KSMUnsure6Instruction
};
