...
class SigilKSMBreakInstruction extends SigilKSMInstruction {
  public override get const(): boolean {
    return false;
  }

  public override get opcode(): number {
    return SigilKSMOpCode.OPCODE_BREAK;
  }
...
export { SigilKSMBreakInstruction, SigilKSMBreakInstruction as KSMBreakInstruction };
