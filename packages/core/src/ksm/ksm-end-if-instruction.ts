...
class SigilKSMEndIfInstruction extends SigilKSMInstruction {
  public override get const(): boolean {
    return false;
  }

  public override get opcode(): number {
    return SigilKSMOpCode.OPCODE_END_IF;
  }
...
export { SigilKSMEndIfInstruction, SigilKSMEndIfInstruction as KSMEndIfInstruction };
